<template>
  <div class="background">
    ...
    <div class="body">
      <img alt="Facebook-logo" class="image" src="@/assets/Facebook.png" width="120" height="110" />
      <span class="text">{{ $t('create an action when a user publish a new post') }}</span>
      <input type="text" v-model="url" :placeholder="$t('Please enter the URL of the Facebook Channel')" class="text-input">
...
const validateButton = () => {
  if (url.value === '')
    ...
    emit('return-value', { value: `${urlString}`, name: 'Facebook(Action: NewPostUrl)',});
    emit('back-to-areas');
  }
};
