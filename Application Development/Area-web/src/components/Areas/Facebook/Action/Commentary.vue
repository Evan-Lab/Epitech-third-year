<template>
  <div class="background">
    ...
    <div class="body">
      ...
      <span class="text">{{ $t('create an action when comment is posted') }}</span>
      <input type="text" v-model="url" :placeholder="$t('Please enter the URL of the Facebook Post')" class="text-input">
...
const validateButton = () => {
  if (url.value === '')
    ...
    emit('return-value', { value: `${urlString}`, name: 'Youtube(Action: Commentary)',});
    emit('back-to-areas');
  }
};
