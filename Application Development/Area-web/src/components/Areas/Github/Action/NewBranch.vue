<template>
  <div class="background">
    ...
    <div class="body">
      ...
      <span class="text">{{ $t('Create an action when creating a branch in the repositories') }}</span>
...
const validateButton = () => {
  if (repo.value === '')
    ...
    emit('return-value', { value: `${repoString}`, name: 'Github(Action: NewBranch)', id: 3});
    emit('back-to-areas');
  }
};
