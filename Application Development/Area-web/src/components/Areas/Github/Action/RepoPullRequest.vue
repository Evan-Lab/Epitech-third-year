<template>
  <div class="background">
    ...
    <div class="body">
      ...
      <span class="text">{{ $t('Create an action when you receive a pull request in a repository') }}</span>
...
const validateButton = () => {
  if (repo.value === '')
    ...
    emit('return-value', { value: `${repoString}`, name: 'Github(Action: RepoPullRequest)', id: 7});
    emit('back-to-areas');
  }
};
