<template>
  <div class="background">
    ...
    <div class="body">
      ...
      <span class="text">{{ $t('Create an action when a collaborator joins your Github repositories') }}</span>
...
const validateButton = () => {
  if (repo.value === '')
    ...
    emit('return-value', { value: `${repoString}`, name: 'Github(Action: NewCollaborator)', id: 4});
    emit('back-to-areas');
  }
};
