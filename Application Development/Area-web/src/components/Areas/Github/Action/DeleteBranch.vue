<template>
  <div class="background">
    ...
    <div class="body">
      ...
      <span class="text">{{ $t('Create an action when a branch is deleted in the repositories') }}</span>
...
const validateButton = () => {
  if (repo.value === '')
    ...
    emit('return-value', { value: `${repoString}`, name: 'Github(Action: DeleteBranch)', id: 2});
    emit('back-to-areas');
  }
};
