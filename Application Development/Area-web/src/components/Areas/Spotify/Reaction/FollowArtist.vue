w<template>
  <div class="background">
    ...
    <div class="body">
      ...
      <span class="text">{{ $t('Follow a Spotify Artist') }}</span>
      <input type="text" v-model="url" :placeholder="$t('Please enter the URL of the Spotify artist')" class="text-input">
...
const validateButton = () => {
  if (url.value === '')
    ...
    emit('return-value', { value: `${urlString}`, name: 'Spotify(Reaction: FollowArtist)',id:3});
    emit('back-to-areas');
  }
};
