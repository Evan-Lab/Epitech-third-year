<template>
  <div class="background">
    ...
    <div class="body">
      ...
      <span class="text">{{ $t('Follow a Spotify playist') }}</span>
      <input type="text" v-model="url" :placeholder="$t('Please enter the URL of the Spotify playlist')" class="text-input">
...
const validateButton = () => {
  if (url.value === '')
    ...
    emit('return-value', { value: `${urlString}`, name: 'Spotify(Reaction: FollowPlaylist)',id:4});
    emit('back-to-areas');
  }
};
